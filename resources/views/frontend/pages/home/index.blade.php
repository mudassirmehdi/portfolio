  ...
  @section('content')
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image:url({{ asset('frontend/images/bg_2.jpg') }}); background-size: cover; background-position: center;">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">Jinnah School & College Piplan</h1>
      ...
      <div class="slider-item" style="background-image:url({{ asset('frontend/images/bg_1.jpg') }}); background-size: cover; background-position: center;">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
      ...
      <div class="slider-item" style="background-image:url({{ asset('frontend/images/bg_4.jpg') }}); background-size: cover; background-position: center;">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">The Best way of learning & discovering</h1>
            <p>A place for learning, discovery, innovation, expression and discourse</p>
            <p><a href="{{ url('contact') }}" class="btn btn-primary px-4 py-3 mt-3">Contact Us</a></p>
          </div>
        </div>
    ...
    <section class="ftco-services ftco-no-pb">
          ...
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Jinnah has a team of tilented teachers that provide a quality to student. Our teacher is proud to us.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Jinnah offer special education to student for their batter futures. we are a famous in our ara.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>We announced a libray soon in our college where student can read any kind of book related to their futures.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Jinnah present a complete solution of entertainment. we offer every year a sports gala</p>
              </div>
            </div>      
          </div>
        </div>
		...
		<section class="ftco-section ftco-no-pt ftc-no-pb">
			<div class="container">
          	...
          	<h2 class="mb-4">What We Offer</h2>
						<p>The Jinnah community is driven by a shared purpose: to make a better life through education, research, and innovation. We are fun and quirky, elite but not elitist, inventive and artistic, obsessed with numbers, and welcoming to talented people regardless of where they come from.</p>
						<div class="row mt-5">
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text pl-3">
										<h3>Safety First</h3>
										<p>We provide greate security to our institution. We take care of our students as well as our teachers.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text pl-3">
										...
										<p>Student attends reqular classis. In which they learn, discover and Experience they feel.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
							...
							<div class="col-lg-6">
								<div class="services-2 d-flex">
									...
									<div class="text pl-3">
										...
										<p>We provide a great environment in our class rooms. We take care of discipline.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
		...
		<section class="ftco-section bg-light">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4">Jinnah Managements</h2>
          </div>
        </div>	
				<div class="row">
					<div class="col-md-4 col-lg-4 ftco-animate">
		                ...
		                <li class="ftco-animate"><a href="https://web.facebook.com/adnan.rana.391082" target="_blank"><span class="icon-facebook"></span></a></li> 
		              </ul>
	              </div>
							</div>
						</div>
					...
					<div class="col-md-4 col-lg-4 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>Amjad Rana</h3>
								<span class="position mb-2">chief Executive Officer</span>
								<div class="faded"> 
									<ul class="ftco-social text-center"> 
		                <li class="ftco-animate"><a href="https://web.facebook.com/profile.php?id=100005100019415" target="_blank"><span class="icon-facebook"></span></a></li> 
		              </ul>
	              </div>
							</div>
						</div>
					...
					<div class="col-md-4 col-lg-4 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>Shahid Anjam Rana</h3>
								<span class="position mb-2">Administrator</span>
								<div class="faded"> 
									<ul class="ftco-social text-center">
		                <!-- <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li> -->
		                <li class="ftco-animate"><a href="https://web.facebook.com/shahid.anjumrana.7" target="_blank"><span class="icon-facebook"></span></a></li>

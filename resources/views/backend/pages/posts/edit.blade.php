               ...
               <div class="row">
                        ...
                        <div class="card-body">
                          <form method="POST" action="{{ route('update.post', $post->id ) }}"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <textarea rows="4" name="ckeditor" id="ckeditor" class="ckeditor form-control @error('ckeditor') is-invalid @enderror">{!! $post->post_description !!}</textarea>
                              @error('ckeditor')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="post_tags" class="form-control @error('post_tags') is-invalid @enderror" value="{{ $post->post_tags }}">
                                  @error('post_tags')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="post_categories" class="form-control @error('post_categories') is-invalid @enderror" value="{{ $post->post_categories }}">
                ...
                <div class="col-md-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <img src="/uploads/posts/{{ $post->post_thumbail }}" style="width: 100%; height: 100%;" id="blah">
                    </div>
                  </div>
                </div>

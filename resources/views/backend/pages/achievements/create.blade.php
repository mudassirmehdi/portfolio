        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white" id="v-pills-tab">
                    ...
                    <li>
                        <a class="nav-link active" href="{{ url('admin/achievements/create') }}"><i class="icon icon-plus-circle mb-3"></i>Add New</a>
                    </li> 
                </ul> 
            </div>
        </div>
                ...
                <div class="row my-3">
                  <div class="col-md-8">
                    ...
                    <div class="card mb-3 shadow no-b r-0">
                        ...
                        <div class="card-body">
                          <form method="POST" action="{{ route('add.achievement') }}"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="student_field" class="form-control @error('student_field') is-invalid @enderror" value="{{ old('student_field') }}">
                                    @error('student_field')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                            ...
                            <div class="form-group">
                              ...
                              <textarea rows="4" name="student_description" class="form-control @error('student_description') is-invalid @enderror">{{ old('student_description') }}</textarea>
